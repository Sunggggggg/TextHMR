...
class Loss(nn.Module):
    ...
    def forward(
        ...
        # 
        real_2d = real_2d[:, seq_len // 2 - 4: seq_len // 2 + 5]
        real_3d = data_3d['kp_3d'][:, seq_len // 2 - 4: seq_len // 2 + 5]
        real_3d_theta = data_3d['theta'][:, seq_len // 2 - 4: seq_len // 2 + 5]
        w_3d = data_3d['w_3d'].type(torch.bool)[:, seq_len // 2 - 4: seq_len // 2 + 5]
        w_smpl = data_3d['w_smpl'].type(torch.bool)[:, seq_len // 2 - 4: seq_len // 2 + 5]
